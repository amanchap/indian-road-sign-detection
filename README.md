...
Detect and classify **78 types of Indian road signs** from dashcam imagery using a two-stage YOLO pipeline built on the IRC:67-2012 standard.

![Python](https://img.shields.io/badge/Python-3.10+-blue)
![YOLO](https://img.shields.io/badge/YOLOv8-Ultralytics-purple)
![mAP](https://img.shields.io/badge/mAP50-96.7%25-brightgreen)
![Classes](https://img.shields.io/badge/IRC_Classes-78-orange)
![License](https://img.shields.io/badge/License-Commercial-red)

> **Try the API →** [RapidAPI Marketplace](https://rapidapi.com/praveenamancharla/api/indian-road-sign-detection)
>
> **Live Demo →** [skotantrx.com/demo.html](https://skotantrx.com/demo.html)
...
```
Dashcam Frame → YOLO Locator → Crop → YOLO Classifier → Sign Type + Confidence
                   (find)              (identify)
                 mAP50: 96.5%         78 IRC classes
```

**Two-stage pipeline:**
1. **Stage 1 — Locator**: YOLO model finds sign bounding boxes in the full frame (mAP50 = 96.5%)
2. **Stage 2 — Classifier**: Second YOLO model identifies the sign type from the cropped region (78 classes)
...
- **Driving assessment** — automated driving test evaluation (see [Pālan](https://skotantrx.com))
...
[Subscribe on RapidAPI →](https://rapidapi.com/praveenamancharla/api/indian-road-sign-detection)
...
**[SKO TantrX](https://skotantrx.com)** — Break the Old. Build the Bold.

Deep tech company building computer vision and AI solutions for Indian roads.

- 🌐 [skotantrx.com](https://skotantrx.com)
- 💼 [LinkedIn](https://www.linkedin.com/company/144977909/)
- 📧 info@skotantrx.com
